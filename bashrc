...
# setting this variable to trus will add an asterisk to your command propt
...
# keep markup-convert and other tools from stealing window focus
export JAVA_TOOL_OPTIONS="-Djava.awt.headless=true"

export JAVA_HOME=/usr/lib/jvm/jdk1.7.0_79
export IDEA_JDK=/usr/lib/jvm/jdk1.8.0_45
